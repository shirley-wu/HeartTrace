...
public class DiaryGetByRestrictTest extends InstrumentationTestCase {
    ...
    public void testGetByRestrictText() throws SQLException {
        ...
        list = Diary.getByRestrict(databaseHelper, "Shirley", null, null, null);
        assertEquals(30, list.size());

        list = Diary.getByRestrict(databaseHelper, "Lisa", null, null, null);
        assertEquals(29, list.size());

        list = Diary.getByRestrict(databaseHelper, "hello Lisa", null, null, null);
    ...
    public void testGetByRestrictDate() throws SQLException {
        List<Diary> list;
        list = Diary.getByRestrict(databaseHelper, null, new Date(2016, 1, 5), new Date(2016, 1, 23), null);
    ...
    public void testGetByRestrictLabel() throws SQLException {
        ...
        labelList.add(labels.get(0));
        list = Diary.getByRestrict(databaseHelper, null, null, null, labelList);
