...
public class SentenceGetByRestrictTest extends InstrumentationTestCase {
    ...
    public void testWhereSingleText() throws SQLException {
        Dao<Sentence, Long> dao = databaseHelper.getDao(Sentence.class);
        QueryBuilder<Sentence, Long> qb = dao.queryBuilder();
    ...
    public void testBuildWhereDateAndSingleText() throws SQLException {
        Dao<Sentence, Long> dao = databaseHelper.getDao(Sentence.class);
        QueryBuilder<Sentence, Long> qb = dao.queryBuilder();
        Where<Sentence, Long> w = qb.where();
    ...
    public void testGetByRestrictText() throws SQLException {
        ...
        list = Sentence.getByRestrict(databaseHelper, "Shirley", null, null, null, true);
        assertEquals(30, list.size());

        list = Sentence.getByRestrict(databaseHelper, "Lisa", null, null, null, true);
        assertEquals(29, list.size());

        list = Sentence.getByRestrict(databaseHelper, "hello Lisa", null, null, null, true);
    ...
    public void testGetByRestrictDate() throws SQLException {
        List<Sentence> list;
        list = Sentence.getByRestrict(databaseHelper, null, new Date(2016, 1, 5),
    ...
    public void testGetByRestrictLabel() throws SQLException {
        ...
        labelList.add(labels.get(0));
        list = Sentence.getByRestrict(databaseHelper, null, null, null, labelList, true);
