...
public class CombinedChartManager {
    ...
    private BarData getBarData(List<Float> barChartY, String barName, List<Integer> barColor) {
    ...
    public void showCombinedChart(
            ...
            , String barName, String lineName, List<Integer> barColor, int lineColor) {
        initChart();
