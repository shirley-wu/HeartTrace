...
public class Sentencebook implements Serializable {
    ...
    public void insert(DatabaseHelper helper) {
        try {
            Dao<Sentencebook, Integer> dao = helper.getDao(Sentencebook.class);
    ...
    public void delete(DatabaseHelper helper) {
        try {
            Dao<Sentence, Integer> subdao = helper.getDao(Sentence.class);
    ...
    public static List<Sentencebook> getAll(DatabaseHelper helper, Boolean ascending){
        try {
            QueryBuilder<Sentencebook, Integer> qb = helper.getDao(Sentencebook.class).queryBuilder();
            return qb.query();
        } catch (SQLException e) {
            Log.e(DatabaseHelper.class.getName(), "Can't dao database", e);
            throw new RuntimeException(e);
