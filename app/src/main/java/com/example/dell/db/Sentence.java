...
public class Sentence implements Serializable
{
    ...
    public void insert(DatabaseHelper helper) {
        try {
            Dao<Sentence, Integer> dao = helper.getDao(Sentence.class);
    ...
    public void delete(DatabaseHelper helper) {
        try {
            DeleteBuilder<SentenceLabel, Integer> deleteBuilder = helper.getDao(SentenceLabel.class).deleteBuilder();
    ...
    public void deleteLabel(DatabaseHelper helper, Label label) {
        try {
            QueryBuilder<SentenceLabel, Integer> qb = helper.getDao(SentenceLabel.class).queryBuilder();
    ...
    public static List<Sentence> getByDate(DatabaseHelper helper, int year, int month, int day, boolean ascending) {
        try {
            ...
            QueryBuilder<Sentence, Integer> qb = helper.getDao(Sentence.class).queryBuilder();
    ...
    public List<Label> getAllLabel(DatabaseHelper helper) throws SQLException {
        ...
        QueryBuilder<Label, Integer> labelQb = helper.getDao(Label.class).queryBuilder();
        labelQb.join(qb);
    ...
    public static long countByDateLabel (DatabaseHelper helper, Date begin, Date end, List<Label> labelList) {
        try {
            QueryBuilder<Sentence, Integer> queryBuilder = helper.getDao(Sentence.class).queryBuilder();
    ...
    public static void buildQuery(QueryBuilder<Sentence, Integer> qb, DatabaseHelper helper, List<Label> labelList) throws SQLException {
        ...
        for(int i = 0; i < size; i++) {
            QueryBuilder<SentenceLabel, Integer> sentenceLabelQb = helper.getDao(SentenceLabel.class).queryBuilder();
